...
def get_block_level_messages_dets(block_specs, xml: str, *, warnings_only=False, execute_code=True, repeat_set=None):
    """
...
def get_overall_snippet_messages_dets(snippet, block_specs, *,
